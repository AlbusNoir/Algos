...
def addGosperGliderGun(i, j, grid):
    ...
    In the Game of Life, for every p greater than or equal to 14,
    it is possible to construct a glider gun in which the gliders are emitted with period p"""
...
# main() function
def main():
    # initial greeting and list of args
    #input('Press Enter to run. You can specify the grid-size, interval, and glider. Rerun with args to do so')
